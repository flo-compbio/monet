...
from ..visualize import tsne_plot, umap_plot, force_plot
from .. import util
...
def force(matrix: Union[str, ExpMatrix],
         cell_labels: Union[str, ExpMatrix] = None,
         num_components: int = 50,
         cluster_colors: Dict[str, str] = None,
         **kwargs) -> Tuple[go.Figure, pd.DataFrame]:
    """Visualize cells using a force-directed layout."""
